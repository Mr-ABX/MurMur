    ...
    <div className="flex-1 h-full overflow-y-auto p-8 space-y-6 bg-[#000000] text-[#ededed]">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-[#ededed] tracking-tight flex items-center gap-2">
            <Palette className="w-5 h-5 text-amber-400" /> Cleanup Styles & Per-App Rules
          </h1>
      ...
      {isAdding && (
        <div className="p-5 rounded-2xl bg-[#121215] border border-[#2a2a32] space-y-4">
          <h2 className="text-xs font-semibold uppercase tracking-wider text-[#ededed] flex items-center gap-2">
            <Sliders className="w-4 h-4 text-amber-400" /> New Per-App Prompt Rule
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#09090b] border border-[#1e1e24] rounded-xl px-3 py-1.5 text-xs text-white placeholder:text-zinc-500 focus:outline-none focus:border-amber-400/50"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-[#09090b] border border-[#1e1e24] rounded-xl p-3 text-xs text-white placeholder:text-zinc-500 focus:outline-none focus:border-amber-400/50 resize-none"
            />
          </div>
      ...
      <div className="space-y-3">
        {promptRules.map((rule) => {
          ...
          return (
            <div key={rule.id} className="p-4 rounded-2xl bg-[#121215] border border-[#1e1e24] space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-7 h-7 rounded-xl bg-[#18181c] border border-[#2e2e2e] flex items-center justify-center text-zinc-300">
              ...
              <div className="p-3 rounded-xl bg-[#09090b] border border-[#1e1e24]">
