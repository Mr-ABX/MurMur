...
export const MeetingTranscriptionView: React.FC = () => {
  ...
  return (
    <div className="flex-1 h-full overflow-y-auto p-8 space-y-6 bg-[#000000] text-[#ededed]">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-[#ededed] tracking-tight flex items-center gap-2">
            <Users className="w-5 h-5 text-emerald-400" /> Meeting Tools & File Transcription
          </h1>
      ...
      {/* File Dropzone */}
      <div className="p-8 rounded-lg bg-[#0f0f11] border-dashed border border-[#333333] hover:border-[#555555] transition-all flex flex-col items-center justify-center text-center cursor-pointer group">
        <div className="w-10 h-10 rounded-lg bg-[#1a1a1a] border border-[#2e2e2e] text-zinc-300 flex items-center justify-center mb-3 group-hover:text-white transition-colors">
      ...
      <div className="p-5 rounded-lg bg-[#0f0f11] border border-[#222222] space-y-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleCopy}
              className="btn-liquid-ghost px-3 py-1.5 text-xs flex items-center gap-1"
            >
            ...
            <button
              ...
              className="btn-liquid-primary px-3.5 py-1.5 text-xs flex items-center gap-1.5 font-semibold"
            >
        ...
        <textarea
          ...
          className="w-full bg-[#0a0a0a] border border-[#222222] rounded-md p-4 text-xs text-white font-mono leading-relaxed focus:outline-none focus:border-[#444444] resize-none"
        />
      </div>
    </div>
  );
