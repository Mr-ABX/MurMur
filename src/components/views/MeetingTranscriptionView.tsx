...
export const MeetingTranscriptionView: React.FC = () => {
  ...
  return (
    <div className="flex-1 h-full overflow-y-auto p-8 space-y-6 bg-[#000000] text-[#ededed]">
      ...
      {/* File Dropzone */}
      <div className="p-8 rounded-2xl bg-[#121215] border-dashed border border-[#2a2a32] hover:border-white/30 transition-all flex flex-col items-center justify-center text-center cursor-pointer group">
